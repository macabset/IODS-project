...
Our 3 tests of regression model show that our Multiple R-squared lowers each time we drop a variable. That happens, because it increases every time you add a variable.  What we also see is that the 2nd test has the highest adjusted R-square, even though it has more variables than the last one.
