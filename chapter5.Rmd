...
##Reduction with continuous variables - Principal component analysis
First part of our dimensionality reduction conserns with continuous variables. Dimensionality reduction in general aims to find the most essential dimensions than explain the data. Our goal is to find the principal components from the data that explain the data. Hence, the principal component analysis
###Our data
